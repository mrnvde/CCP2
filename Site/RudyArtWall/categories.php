...
?>
    <main class="row overflow-auto" id="corps">
       <div class="col-12 col-md-10">
            <div id="tete">
               <h4 class="text-center">Voici les catégories de photos :</h4>
            </div>
            <div id="corps" class="container">
                <div class="row">
                    <div>
                        <form method="post" action="">
                            <div class="form-select" id="selectCatImg" name="selectCatImg">
                                    <?php
                                    ...
                                    ?>
                                    <img src="<?= $catImg->IMAGE_LOGO_CATEGORIES ?>" width="200" height="200"><br>
